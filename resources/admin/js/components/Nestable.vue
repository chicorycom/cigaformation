<template>
    <ol class="dd-list">
        <li class="dd-item"  v-for="item in menu_items">
            <div class="dd-handle">
                <div class="pl-3">
                ...
                <div class="item_actions ">
                    ...
                    <button class="btn btn-sm btn-danger pull-right delete" v-on:click="$emit('del', item)">
                        <i class="fas fa-trash"></i>
                    </button>
                </div>
            </div>
            <nestable :menu_items="item.children" @del="delin" @edit="editing"></nestable>
        </li>
    </ol>
</template>
